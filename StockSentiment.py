...
URL_Apple = 'https://www.quandl.com/api/v3/datasets/AOS/AAPL.json?api_key=zwzJQCDVUU-CXGCxSiY_'
URL_Boeing = 'https://www.quandl.com/api/v3/datasets/AOS/BA.json?api_key=zwzJQCDVUU-CXGCxSiY_'
URL_Chevron = 'https://www.quandl.com/api/v3/datasets/AOS/CVX.json?api_key=zwzJQCDVUU-CXGCxSiY_'
URL_Cisco = 'https://www.quandl.com/api/v3/datasets/AOS/CSCO.json?api_key=zwzJQCDVUU-CXGCxSiY_'
URL_AmericanExpress = 'https://www.quandl.com/api/v3/datasets/AOS/AXP.json?api_key=zwzJQCDVUU-CXGCxSiY_'
WriteCount = 0
...
fil = open('StockSentiment.csv', 'w', newline='')	#Use Python's CSV object to write data
